    	...
    	class XmlSchemaValidator {
    		...
    		public void validate(InputStream xmlStream, InputStream schemaStream, String baseUri, String localPath)
    			...
    			factory.setResourceResolver((type, namespaceURI, publicId, systemId, baseURI) -> {
    				...
    				input.setCharacterStream(new InputStreamReader(getSchemaAsStream(input.getSystemId(),
    								input.getPublicId(), input.getBaseURI(), localPath)));
    				return input;
    			});
    			Schema schema = factory.newSchema(new StreamSource(schemaStream));
    		...
    		private InputStream getSchemaAsStream(String systemId, String publicId, String baseUri, String localPath) {
